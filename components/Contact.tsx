            ...
            >
              ...
              <div>
                ...
                <div className="flex space-x-4">
                  {[
                    { icon: <Github size={20} />, href: 'https://github.com/riyanramteke17' },
                    { icon: <Linkedin size={20} />, href: 'https://www.linkedin.com/in/riyan-dev/' },
            ...
            >
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  ...
                  className={`w-full py-4 rounded-xl font-bold flex items-center justify-center space-x-2 transition-all ${submitted
