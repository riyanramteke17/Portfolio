          ...
          {PROJECTS.map((project, idx) => (
            ...
            >
              <div className="relative overflow-hidden rounded-2xl mb-6 shadow-lg aspect-video bg-slate-200 dark:bg-slate-800">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-slate-900 via-slate-900/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-8">
                  <div className="flex space-x-4">
                    <a href={project.githubUrl} className="p-3 bg-white/20 hover:bg-white/40 rounded-full backdrop-blur-md text-white transition-all" target="_blank" rel="noopener noreferrer">
                      <Github size={20} />
                    </a>
                    <a href={project.liveUrl} className="p-3 bg-primary-500 hover:bg-primary-600 rounded-full text-white transition-all" target="_blank" rel="noopener noreferrer">
              ...
              <div className="space-y-4 px-2">
                ...
                <a href={project.liveUrl} className="inline-flex items-center text-primary-500 font-bold group/link" target="_blank" rel="noopener noreferrer">
